...
type SwordsmanFour struct {
	Troop
}

func NewSwordsmanFour(team common.Team, pos common.Position) Entity {
	return &SwordsmanFour{
		Troop: Troop{
			Type:     "SwordsmanFour",
			Health:   16,
			Damage:   5,
...
func (t *SwordsmanFour) CalculateAction(mv MapView) Action {
	action := Action{
